...
关于条件渲染的详细说明，可以参考[if/else：条件渲染](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/quick-start/arkts-rendering-control-ifelse.md)。
...
关于显隐控制的详细说明，可以参考[显隐控制](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-universal-attributes-visibility.md)。

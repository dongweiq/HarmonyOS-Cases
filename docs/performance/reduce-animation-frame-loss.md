...
更详细的API文档请参考：[属性动画](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-animatorproperty.md)。
...
更详细的API文档请参考：[显式动画](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-explicit-animation.md)。

...
布局是UI的必要元素，它定义了组件在界面中的位置。ArkUI框架提供了多种布局方式，除了基础的[线性布局](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/ui/arkts-layout-development-linear.md)（[Row](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-row.md)/[Column](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-column.md)）、[层叠布局](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/ui/arkts-layout-development-stack-layout.md)（[Stack](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-stack.md)）、[弹性布局](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/ui/arkts-layout-development-flex-layout.md)（[Flex](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-flex.md)）、[相对布局](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/ui/arkts-layout-development-relative-layout.md)（[RelativeContainer](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-relativecontainer.md)）、[栅格布局](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/ui/arkts-layout-development-grid-layout.md)（[GridCol](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-gridcol.md)）外，也提供了相对复杂的[列表](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/ui/arkts-layout-development-create-list.md)（[List](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-list.md)）、[网格](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/ui/arkts-layout-development-create-grid.md)（[Grid](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-grid.md)/[GridItem](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-griditem.md)）、[轮播](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/ui/arkts-layout-development-create-looping.md)（[Swiper](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-swiper.md)）。
...
使用扁平化布局推荐使用[RelativeContainer](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-relativecontainer.md)、[绝对定位](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-universal-attributes-location.md)、[自定义布局](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-custom-component-lifecycle.md)、[Grid组件](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/arkui-ts/ts-container-grid.md)等

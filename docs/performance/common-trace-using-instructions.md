...
以下示例采用`LazyForEach`的方式遍历列表，并借助[SmartPerf-Host调试工具](https://docs.openharmony.cn/pages/v4.1/zh-cn/device-dev/device-test/smartperf-host.md)追踪代码执行流程。
...
下面使用[SmartPerf-Host调试工具](https://docs.openharmony.cn/pages/v4.1/zh-cn/device-dev/device-test/smartperf-host.md)抓取htrace文件，并生成一个跟踪泳道分析图，来了解示例代码的加载流程。跟踪泳道分析图被分为五个部分，每个部分都标注数字并框选出相应的标签，从而使得整体的过程能够得到更好的理解。
...
> [性能打点跟踪开发指导（ArkTS）](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/dfx/hitracemeter-guidelines.md/)
> [性能打点跟踪开发指导（Native）](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/dfx/hitracemeter-native-guidelines.md/)

添加自定义Trace后，可在[SmartPerf-Host调试工具](https://docs.openharmony.cn/pages/v4.1/zh-cn/device-dev/device-test/smartperf-host.md)上查看，自定义Trace将以独立泳道的形式呈现在对应打点的进程下。
...
> [hiTraceMeter模块](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/native-apis/_hitrace.md/)
